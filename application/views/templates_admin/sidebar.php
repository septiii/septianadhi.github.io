      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">LOGISTIK KSB</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="<?php echo base_url('admin/data_barang') ?>"><i class="fas fa-alien"></i> <span>DATA BARANG</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('admin/data_jenis') ?>"><i class="fas fa-grip-horizontal"></i> <span>DATA JENIS</span></a></li>
